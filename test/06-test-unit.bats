...
@test "test skip & summary" {
    ...
    [[ ${BAUX_UNIT_COUNTS[TOTAL]} -eq 4 ]]
    [[ ${BAUX_UNIT_COUNTS[PASS]} -eq 2 ]]
    [[ ${BAUX_UNIT_COUNTS[FAIL]} -eq 0 ]]
    [[ ${BAUX_UNIT_COUNTS[SKIP]} -eq 2 ]]
}
